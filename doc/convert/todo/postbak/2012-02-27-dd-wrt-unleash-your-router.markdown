...
+ You have to <a href="https://www.dd-wrt.com/wiki/index.php/Supported_Devices" title="investigate">investigate</a>the router to make sure you buy a supported model and hardware revision 
